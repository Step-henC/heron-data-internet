...
const handleSubmit = (e) => {
    ...
    if( (subject.match(/^\S/g) && subject.length >0) && (message.length >= 5 && message.match(/^\S/g)) && (email.match(EMAIL_PATTERN))){
    ...
    return (
            ...
            <form onSubmit={handleSubmit} ref={formRef} id="csv-elem" aria-label="form to contact us" >
                ...
                {!subjValid && (
                  <li className="form-col">
                    <p
                      ...
                      style={{ color: "red" }}
                    >
                      Error: Please provide a valid subject. Must be at least 1 characters and begin with a non-whitespace character
                    </p>
                  </li>
                )}
                <br/>
                  ...
                  <li className="form-col">
                    <label
                    aria-label='message of to Heron Data'
                      htmlFor="message"
                    >
                      Your Message
                    </label>
                  ...
                  <li className="form-col">
                    <p
                      ...
                      style={{ color: "red" }}
                    >
                      Error: Please provide a valid message. Must be at least 5 characters and begin with a non-whitespace character
                    </p>
                  </li>
                )}
